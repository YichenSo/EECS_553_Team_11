...
if __name__ == "__main__":
    model_path = "./gail_torch/assets/learned_models/dpo_sup/model_final.pkl"
    ...
    for loc in visited_loc:
        loc_idx = loc[0] * env.map_size[0] + loc[1]
        temp = expert_transition_cnt[loc_idx].sum()
    ...
    plt.savefig("state_predictor_sup.pdf", dpi=300, bbox_inches="tight")
