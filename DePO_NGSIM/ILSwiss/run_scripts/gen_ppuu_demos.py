...
def split_train_test(scenario_name, test_ratio, vehicle_num):
...
def generate_demos(
    train_vehicle_ids, test_vehicle_ids, scenario_name: str, obs_stack_size: int = 1
):
